...
p2 <- states %>% 
  ...
  annotate(
    ...
    x = -125,
    y = 62,
    label = '**Which US region have the most renewable<br>energy fuel stations?**',
    hjust = 0, 
    vjust = 0, 
    size = 6, 
    label.colour = NA
  ...
  theme_void() + 
  # labs(
  #   title = 'Which US region have the most renewable energy fuel stations?',
  #   subtitle = str_c(c(pacific_state_text, midatlantic_state_text), collapse = '<br>')
  # ) +
  theme(
